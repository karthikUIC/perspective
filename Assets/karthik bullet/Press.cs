    ...
    void Update()
    {
        if (Input.GetKeyDown("space"))
        {
            ...
            Muzzle_Flash =
                ...
                Bullet_Emitter.transform.rotation) as
                GameObject;
            Muzzle_Flash.transform.Rotate(-90f, 90f, 0f);
            ...
            Temporary_RigidBody =
                Temporary_Bullet_Handler.GetComponent<Rigidbody>();

            //Tell the bullet to be "pushed" forward by an amount set by Bullet_Forward_Force.

            Temporary_RigidBody
                .AddForce(transform.forward * Bullet_Forward_Force);
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        )
        {
            ...
            Muzzle_Flash =
                ...
                // Muzzle_Flash.transform.position =  Muzzle_Flash.transform.position + ;
            Muzzle_Flash.transform.Rotate(-90f, 90f, 0f);
          //  Muzzle_Flash.transform.Rotate(-90f, 90f, 0f);
